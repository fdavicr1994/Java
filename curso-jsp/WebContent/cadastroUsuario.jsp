...
<body>
	...
	<table>
		<c:forEach items="${usuarios}" var="user">
			<tr>
				<td style="width: 75px"><c:out value="${user.id}"></c:out></td>
				<td style="width: 75px"><c:out value="${user.login}"></c:out></td>
				<td style="width: 25px"><c:out value="${user.senha}"></c:out></td>
				
				<td style="width: 25px"><a href="salvarUsuario?acao=delete&user=${user.login}">Excluir</a></td>
				<td style="width: 25px"><a href="salvarUsuario?acao=editar&user=${user.login}">Editar</a></td>
			</tr>
		</c:forEach>
	</table>
</body>
